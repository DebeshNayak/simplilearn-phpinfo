# download Alpine docker image (alpine operating system WITHOUT any kernetl because container use the kernel of the HOST machine)
...
# without brackets: sh -c "php -f index.php -S 0.0.0.0:8080"
